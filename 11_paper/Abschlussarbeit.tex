...
\(R^2\in\{0,0.05,...,0.95\}\), and cases of determinstic trends in the
...
Furthermore, the Ohrnstein Uhlenbeck Process has to be modelled.
...
zero distribution.\footnote{For futher details see
  \textcite{pesavento2004}}
