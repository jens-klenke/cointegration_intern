...
It requieres an object of classes \texttt{co.test} or \texttt{bh.test},
...
package \textbf{ggplot2}. \texttt{ggplot::stat\_ecdf()} is then used to
plot the null distribution. In addition, the value of the Bayer-Hanck
statistic is marked with a dotted x-intercept line.
