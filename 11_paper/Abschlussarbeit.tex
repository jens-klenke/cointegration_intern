...
Due to the availability of the simulated distributions unter the
...
regressors and trendtypes, a simulated \(\mathcal{H}_0\) distribution
...
trendtypes, once the package is further developed.
