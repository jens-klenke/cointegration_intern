...
The package shall be illustrated on the data set `weather` from the package **nycflights13** [@wickham_nycflights13_2020]. It contains the hourly meteorological data for the airports LGA, JFK and EWR of the New York metropolitan area. We will test for a cointegration relationship between the variables *humid*, *temp* and *pressure*. These stand for the relative humidity, temperature and sea level pressure in millibars. 
