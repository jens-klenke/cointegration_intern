...
```{r , p_stat_e_j_k.1, echo = FALSE, fig.cap = " \\label{fig:e_j_k.1} Corrected (blue) and uncorrected (red) $p$-value predictions for all cases and K = 1, using Engle-Granger and Johansen as underlying tests.", fig.height = 1.75}
plot_p_stat_e_j_k.1
```
