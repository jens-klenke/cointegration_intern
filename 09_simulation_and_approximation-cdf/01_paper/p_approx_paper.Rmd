...
It is visible from \eqref{eq:6} that @Boxcox_1964 developed these transformations for the dependent variable. @Kuhn_2013, however, report that it proves as effective for transforming individual regressors. 
...
\FloatBarrier
```{r 5 best all_1, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r , p_stat_e_j, echo = FALSE, fig.cap = " \\label{fig:fig_4} Corrected and uncorrected $p$-value predictions for the first case using Johansen and Engel-Granger as underlying tests.", fig.height = 8}
plot_p_stat_e_j
```
