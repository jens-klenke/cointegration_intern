...
variables in \(x_t\) are not cointegrated. It further follows from
\eqref{eq:13} that the vector \(\mathbf{z}_t\) is cointegrated if
...
\(\mathcal{H}_0 : (\varphi_0, \bm{\phi}^{'}_1)' = 0\).
...
are already tweaking on the fifth decimal place, we will not further
